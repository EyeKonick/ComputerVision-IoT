"""
Hand & Finger AR Tracker — classroom demo.

Tracks up to two hands via webcam and overlays:
  - a neon glowing skeleton over the detected hand
  - particle trails following each fingertip
  - a live gesture readout (finger count + pinch detection)
  - a virtual glowing orb you can touch/drag with your index fingertip

Controls:
  q / ESC  - quit
  r        - reset the virtual orb to the center
"""
...
def main():
    ...
    while True:
        ...
        # Dark vignette-ish backdrop so neon pops.
