...
// Each group carries its approximate line range plus one line of trailing
// context, so a student moving between steps can tell "is this new code a
// continuation of what I just typed, or does it get inserted somewhere in
// the middle" — see ticket 06's Notes on why plain code alone wasn't enough.
